...
The following screenshots show how to change the wireless settings for all master TXT controllers **TXT0-4**. Please replace the IP address 192.168.0.**10** with the corresponding IP address 192.168.0.**1X** of the TXT controller. Repeat configuration for all master TXT controllers. 
