...
If you use the fischertechnik Cloud [https://www.fischertechnik-cloud.com](www.fischertechnik-cloud.com), then you have to pair your TXT controller by executing *Settings* -> *Network* -> *Cloud Setup* -> *Pairing New*
